...
- [Music Assistant] integration now supports pre-announce URLs, thanks to [@arturpragacz]. Use your custom announcement sounds before your text-to-speech messages plays!
...
- Thanks to [@ptarjan], the [Hikvision] integration now has a camera support! You can view snapshots and streams from your Hikvision cameras and NVRs directly in Home Assistant.
...
- The **Developer tools** have been moved to the {% my general title="**Settings**" %} area. We moved it to keeps all administrative tools in one place.
