...
With this release, we're introducing a brand-new Home dashboard. Its purpose is simple: give you easy access to the right information at the right time. The dashboard adapts to your experience: powerful enough for advanced users, yet approachable for newcomers. It should truly earn the name Home and become the default dashboard of Home Assistant. As always, it's optional, you can always pick your own dashboard.

This is the first iteration, and we'll continue developing it in the open. It gives you a complete overview of your home in one place. You can browse by areas and quickly access key domains such as lights, climate, security, and media players.

We're also introducing Favorites. You can pin any entity to the top, whether it's a light, climate, or a person. We'd love to see what you choose (more on this later).
...
For now, the Home dashboard is considered experimental. Configuration options are limited, and it's guaranteed to evolve. It won't appear automatically, you'll need to add it manually if you'd like to try it out.
...
Got feedback on it during our beta testing period? [Join the #beta channel in our Discord chat server](/join-chat)!
