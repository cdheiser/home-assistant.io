...
on **May 24th 2025**; over **50!** meetups are being organized **all around the
...
- [Z-Wave Long Range support and improved Smart Start experience](#z-wave-long-range-support-and-improved-smart-start-experience)
...
## Z-Wave Long Range support and improved Smart Start experience
...
Both have pros and cons, mesh networking is recommended for most devices,
but if you have a device that needs to be placed far away, long range
...
[@PeterRager]: https://github.com/PeterRager
...
* Add badges section on the areas strategy editor (#25154) @piitaya
