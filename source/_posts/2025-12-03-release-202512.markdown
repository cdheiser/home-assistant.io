...
<p class="img">
<img src="/images/blog/2025-12/android-add-to.png" alt="Screenshot showing the new 'Add to' option in the more info dialog for an entity in the Home Assistant Android app.">
</p>
