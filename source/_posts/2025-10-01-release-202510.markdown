...
Now we’ve added a new concept: sections of suggested entities. This follows a basic algorithm that suggests entities you have interacted with the most in the past 24 hours. It then shows these entities based on the hour of the day, with only relevant controls being suggested.
