---
layout: post
title: "2026.3: A clean sweep"
description: "Area cleaning for your vacuum, continue on error in the automation editor, Energy dashboard gains real-time badges and a Water Sankey chart, Android phones become voice satellites with wake word detection, and 18 new integrations from the community!"
...
categories:
  - Release-Notes
  - Core
og_image: /images/blog/2026-03/social.png
---
...
The [Open Home Foundation store](https://store.openhomefoundation.org/)
...
Also, mark your calendars: [State of the Open Home 2026](https://sotoh.openhomefoundation.org/)
...
so [grab yours](https://sotoh.openhomefoundation.org/) while you can! 🎟️
...
Got a robot vacuum? You can now tell it exactly which areas to clean! This release introduces the [clean area](/integrations/vacuum#action-clean-area) action, which lets you send your vacuum to clean one or more specific areas on demand, right from Home Assistant. In this release, it's supported by [Matter], [Ecovacs], and [Roborock].
...
- **[Trane Local]**, added by [@bdraco]  
  Locally control [Trane](https://www.trane.com/) and [American Standard](https://www.americanstandardair.com/) thermostats over your network using a direct <abbr title="mutual TLS">mTLS</abbr> connection. No cloud required.
...
- **[Ubisys]**, provided by [ZHA], added by [@abmantis]
...
- **[Matter]** now supports carbon monoxide alarm states and <abbr title="total volatile organic compounds">TVOC</abbr> air quality level sensors. If you have Matter-certified CO sensors or air quality devices, they now show up in Home Assistant. Thanks, [@Leo2442926161] and [@lboue]!
...
- **[Reolink]** cameras gained five new diagonal and continuous rotation <abbr title="pan, tilt, and zoom">PTZ</abbr> buttons, plus the PTZ patrol switch now correctly reports its real-time status. Thanks, [@starkillerOG]!
...
- **[Ambient Weather Station]** now exposes sensors for the AQIN indoor air quality monitor, including PM2.5, PM10, CO2, temperature, humidity, and <abbr title="air quality index">AQI</abbr> measurements. Thanks, [@n-6]!
...
- [Reconfiguration support for webhook helper](https://developers.home-assistant.io/blog/2026/02/18/reconfiguration-support-for-webhook-helper)
