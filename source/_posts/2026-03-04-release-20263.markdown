...
You can also reach this mapping at any time through the vacuum's entity settings. Open the vacuum entity, select the {% icon "mdi:cog-outline" %} settings icon, and look for the **Map vacuum segments to areas** section.
...
The **Now** view gained tile cards that show real-time power consumption, gas flow rate, and water flow rate at a glance. Water also gets its own Sankey chart in the **Now** view, giving you a visual breakdown of water usage across your home, just like the existing power Sankey chart.
...
**TODO:** Add screenshot of the new energy settings page with tabs
...
- **[Hegel Amplifier]**, added by [@boazca]  
...
- **[Homevolt]**, added by [@Danielhiversen]  
...
- **[MTA New York City Transit]**, added by [@OnFreund]  
...
- **[OneDrive for Business]**, added by [@zweckj]  
...
- **[Powerfox Local]**, added by [@klaasnicolaas]  
...
- **[System Nexa 2]**, added by [@konsulten]  
...
- **[Teltonika]**, added by [@karlbeecken]  
...
- **9 integrations reached platinum** 🏆
  ...
  - [Powerfox Local], thanks to [@klaasnicolaas]
...
- **5 integrations reached silver** 🥈
  ...
  - [Homevolt], thanks to [@Danielhiversen]
